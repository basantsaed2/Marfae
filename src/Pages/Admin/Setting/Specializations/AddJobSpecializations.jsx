...
const AddJobSpecialization = ({ lang = 'en' }) => {
    const apiUrl = import.meta.env.VITE_API_BASE_URL;
    const { postData, loadingPost, response: postResponse } = usePost({ url: `${apiUrl}/admin/addSpecialization` });
    ...
    const title = isEditMode ? 'Edit Specialization' : 'Add Specialization';

    // Define the fields for the form
    const fields = [
        { name: 'specialization', type: 'input', placeholder: 'Specialization Name' },
        {
            type: "switch",
            name: "status",
            placeholder: "Status",
...
export default AddJobSpecialization;