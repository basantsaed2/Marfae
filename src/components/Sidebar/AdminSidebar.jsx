...
const navItems = [
    ...
    { label: "Governorates and Regions", to: "/regions", icon: <CiLocationOn className="stroke-1" size={20} /> },
    {
        ...
        subItems: [
            { label: "Jobs", to: "/job_management/jobs", icon: <GiPill className="stroke-1" size={20} /> },
            { label: "Job Category", to: "/job_management/job_category", icon: <BiCategory size={20} /> },
            { label: "Job Specialization", to: "/job_management/job_specialization", icon: <HiOutlineUserCircle className="stroke-1" size={20} /> },
    ...
    },
    {
        ...
        subItems: [
            { label: "Companies", to: "/company_management/companies", icon: <GiPill className="stroke-1" size={20} /> },
